...
// It is kept in sync here so the committed route tree matches the reconstructed frontend.
...
const LayoutStudentsStudentIdRoute = LayoutStudentsStudentIdRouteImport.update({ id: '/students/$studentId', path: '/students/$studentId', getParentRoute: () => LayoutRoute } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/students/$studentId': { id: '/_layout/students/$studentId'; path: '/students/$studentId'; fullPath: '/students/$studentId'; preLoaderRoute: typeof LayoutStudentsStudentIdRouteImport; parentRoute: typeof LayoutRoute }
...
const rootRouteChildren: RootRouteChildren = { LayoutRoute: LayoutRouteWithChildren, LoginRoute, RecoverPasswordRoute, ResetPasswordRoute, SignupRoute }
