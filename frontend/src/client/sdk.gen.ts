...
export class ImportBatchesService {
     ...
     * Read Import Batches
     */
    public static batchesReadImportBatches<ThrowOnError extends boolean = true>(options?: Options<importBatchesReadImportBatchesData, ThrowOnError>) {
        return (options?.client ?? client).get<importBatchesReadImportBatchesResponses, importBatchesReadImportBatchesErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Create Import Batch
     */
    public static batchesCreateImportBatch<ThrowOnError extends boolean = true>(options: Options<importBatchesCreateImportBatchData, ThrowOnError>) {
        return (options.client ?? client).post<importBatchesCreateImportBatchResponses, importBatchesCreateImportBatchErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/api/v1/import-batches/',
            ...options,
     ...
     * Delete Import Batch
     */
    public static batchesDeleteImportBatch<ThrowOnError extends boolean = true>(options: Options<importBatchesDeleteImportBatchData, ThrowOnError>) {
        return (options.client ?? client).delete<importBatchesDeleteImportBatchResponses, importBatchesDeleteImportBatchErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Read Import Batch
     */
    public static batchesReadImportBatch<ThrowOnError extends boolean = true>(options: Options<importBatchesReadImportBatchData, ThrowOnError>) {
        return (options.client ?? client).get<importBatchesReadImportBatchResponses, importBatchesReadImportBatchErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/api/v1/import-batches/{batch_id}',
            ...options
     ...
     * Update Import Batch
     */
    public static batchesUpdateImportBatch<ThrowOnError extends boolean = true>(options: Options<importBatchesUpdateImportBatchData, ThrowOnError>) {
        return (options.client ?? client).patch<importBatchesUpdateImportBatchResponses, importBatchesUpdateImportBatchErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/api/v1/import-batches/{batch_id}',
            ...options,
     ...
     */
    public static batchesUploadImportBatchWorkbook<ThrowOnError extends boolean = true>(options: Options<importBatchesUploadImportBatchWorkbookData, ThrowOnError>) {
        return (options.client ?? client).post<importBatchesUploadImportBatchWorkbookResponses, importBatchesUploadImportBatchWorkbookErrors, ThrowOnError>({
     ...
     */
    public static batchesPromoteImportBatch<ThrowOnError extends boolean = true>(options: Options<importBatchesPromoteImportBatchData, ThrowOnError>) {
        return (options.client ?? client).post<importBatchesPromoteImportBatchResponses, importBatchesPromoteImportBatchErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
