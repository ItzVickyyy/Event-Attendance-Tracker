...
function NfcWorkspace() { const navigate = useNavigate(); return <Workspace title="NFC" description="Use the existing NFC scanner engine for the selected event." onOpen={() => navigate({ to: "/scanner" })} /> }
