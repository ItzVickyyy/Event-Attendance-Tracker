# Event Attendance Tracker - Docker Compose Deployment
...
* Configure DNS records pointing to the server for the application domain and any supporting service subdomains you want to expose, such as `your-domain.example.com` and `adminer.your-domain.example.com`.
...
export PROJECT_NAME="Event Attendance Tracker"
...
Application (frontend and API): `https://your-domain.example.com`
